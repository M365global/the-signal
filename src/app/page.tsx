    ...
    <main className="min-h-screen bg-[#fcfcfc] text-zinc-950 antialiased selection:bg-zinc-900 selection:text-white print:bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 print:py-0">
        <header className="mb-20 print:mb-10">
          ...
          <h1 className="text-5xl font-sans font-bold tracking-tighter uppercase print:text-6xl">
            The Weekly Signal
          </h1>
        </header>
        ...
        <section className="space-y-16 mb-32 print:space-y-20">
          {headlines.map((item: Headline, index: number) => (
            <article
              key={item.id}
              className="border-b border-zinc-100 pb-12 last:border-0 print:border-zinc-900 print:pb-20"
            >
              <details open className="group print:block">
                    ...
                    <div className="flex-1 space-y-3 w-full">
                      <div className="flex justify-between items-start gap-4">
                        ...
                        <div className="print:hidden shrink-0 mt-1">
                          <ShareButton title={item.title} text={item.quote} />
                        </div>
                      </div>

                      <p className="text-zinc-600 text-lg italic leading-snug group-open:hidden print:block print:text-zinc-500">
                        &quot;{item.quote}&quot;
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-16 space-y-12 animate-in fade-in zoom-in-95 duration-700 print:mt-8 print:animate-none">
                  ...
                  <div className="max-w-xl mx-auto space-y-10">
                    <blockquote className="text-4xl font-sans font-bold italic text-zinc-300 leading-tight border-l-8 border-red-800 pl-10 py-2 print:text-zinc-400 print:border-zinc-900">
                      {item.quote}
                    </blockquote>
                    ...
                    <div className="prose prose-zinc prose-xl font-sans leading-[1.8] text-zinc-800 antialiased prose-p:mb-10 prose-p:leading-relaxed [text-wrap:pretty] print:text-black">
                      ...
                      <div className="mt-16 pt-8 border-t border-zinc-100 flex items-center justify-between print:border-zinc-900">
                        <div className="flex items-center gap-4">
                          ...
                          <span className="text-xs italic text-zinc-500 font-bold uppercase tracking-widest print:text-black">
                            Signal Editorial
                          </span>
                        </div>
                      </div>
        ...
        <footer className="mt-40 bg-zinc-900 text-white p-16 relative overflow-hidden print:hidden">
          <div className="relative z-10 max-w-sm">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row gap-2">
                <Input
                  className="bg-white/10 border-white/20 rounded-none h-14 text-white placeholder:text-zinc-500"
              ...
              >
                <span className="w-4 h-4 bg-zinc-800 flex items-center justify-center text-[8px] border border-zinc-700">
                  in
                </span>
          ...
          <span className="absolute right-[-15%] bottom-[-20%] text-[300px] font-sans font-bold italic opacity-10 pointer-events-none select-none">
            S
          </span>
        </footer>
